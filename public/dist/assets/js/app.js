/*
Template Name: FoodSpot - Responsive Bootstrap 4 Admin Dashboard
Author: CoderThemes
    ...
    */
    ...
    App.prototype.init = function () {
        ...
        if (window.sessionStorage && bodyConfig && bodyConfig.hasOwnProperty('showRightSidebarOnPageLoad') && bodyConfig['showRightSidebarOnPageLoad']) {
            var alreadyVisited = sessionStorage.getItem("_FoodSpot_VISITED_");
            if (!alreadyVisited) {
                $.RightBar.toggleRightSideBar();
                sessionStorage.setItem("_FoodSpot_VISITED_", true);
            }
        }
    },
